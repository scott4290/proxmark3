...
If your OS doesn't prompt you for pairing or if the device connects and immediately disconnects, you can do pair it in command line, e.g. (again, replace with your addon MAC address):
